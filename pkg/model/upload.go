...
type Upload struct {
	...
	NextPmtDate                time.Time `json:"Next Pmt Date" db:"Next Pmt Date"`
	...
	TglRealisasi               time.Time `json:"Tgl Realisasi" db:"Tgl Realisasi"`
	TglJatuhTempo              time.Time `json:"Tgl Jatuh Tempo" db:"Tgl Jatuh Tempo"`
	JangkaWaktu                int       `json:"Jangka Waktu" db:"Jangka Waktu"`
